...
import { InitiatePaymentDto, RefundRequestDto, SimulatePaymentSuccessDto } from '../dto/payment.dto';
...
export class PaymentController {
  ...
  async initiatePayment(@Body() dto: InitiatePaymentDto) {
    return this.paymentService.initiatePayment(dto.studentId, dto.invoiceId, dto.gateway);
  }
  ...
  async refundPayment(@Body() dto: RefundRequestDto) {
    return this.paymentService.initiateRefund(dto.paymentId, dto.amount, dto.reason);
  }

  @Post('subscriptions/create')
  @Roles(RoleEnum.ADMIN, RoleEnum.SUPER_ADMIN, RoleEnum.PARENT)
  @ApiOperation({ summary: 'Create a payment subscription plan for monthly auto-billing' })
  async createSubscription(@Body() dto: CreateSubscriptionDto) {
    return this.paymentService.createSubscription(dto.studentId, dto.planId, dto.gateway);
  }
  ...
  @Roles(RoleEnum.ADMIN, RoleEnum.SUPER_ADMIN, RoleEnum.PARENT, RoleEnum.STUDENT)
