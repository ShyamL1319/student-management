...
export class FeeCollectionController {
  ...
  getPendingFees(@Param('studentId') studentId: string, @Query('academicYearId') academicYearId?: string) {
    return this.feeCollectionService.getPendingFees(studentId, academicYearId);
  }

  @Get('student/:studentId/outstanding')
  getOutstandingAmount(@Param('studentId') studentId: string, @Query('academicYearId') academicYearId?: string) {
    return this.feeCollectionService.getOutstandingAmount(studentId, academicYearId);
  }
  ...
  recordPayment(
    ...
    return this.feeCollectionService.recordPayment(id, body.amountPaid, body.paymentMethod, body.transactionId);
  }
